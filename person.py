...
#TODO add a decay factor/rate with new shows are watched
    #Can do it by multiplying movie_matrix by the decay rate and then adding one for the movie watched
#TODO add a function to indicate they have wathced a show
    #Can do it by multiplying the movies_matrix by a like_rate
